...
const hasPropertyDeliverTo = hasProperty("deliverTo");
const hasPropertyMobileNumber = hasProperty("mobileNumber");
const hasPropertyDishes = hasProperty("dishes");
...
function hasPropertyDishQuantity(req, res, next) {
  const {
    data: { dishes },
  } = req.body;
...
module.exports = {
  ...
  create: [
    hasPropertyDeliverTo,
    hasPropertyMobileNumber,
    hasPropertyDishes,
    orderHasDishes,
    hasPropertyDishQuantity,
    create,
  ],
  update: [
    orderIdExists,
